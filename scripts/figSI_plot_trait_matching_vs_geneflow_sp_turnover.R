...
summaries = dir("~/Lucas/Projects/spatial_coevo_mutnet_results/data/simulations_empirical_networks/sensitivity_analysis/sp_turnover/summary_coevo_results/")
...
for (i in 1:length(summaries)) {
  current_df = read.csv(paste("~/Lucas/Projects/spatial_coevo_mutnet_results/data/simulations_empirical_networks/sensitivity_analysis/sp_turnover/summary_coevo_results/", 
                              summaries[i], sep = ""))
