...
summaries = dir("output/data/simulations_empirical_networks/summary_coevo_results/")
...
for (i in 1:length(summaries)) {
  current_df = read.csv(paste("output/data/simulations_empirical_networks/summary_coevo_results/", 
                              summaries[i], sep = ""))
...
write.csv(summ_final_mut_mat_df, row.names = FALSE, 
          file = "output/data/simulations_empirical_networks/summary_coevo_results/summary_coevo_results_final_mut_matching.csv")
...
# saving
save_plot("output/figs/figS2.pdf", figSI, ncol = 1, nrow = 2, base_aspect_ratio = 1.8)
