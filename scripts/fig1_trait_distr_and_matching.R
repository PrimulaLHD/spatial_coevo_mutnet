...
# Description: 
#  Generates Fig. 1 of the paper, which contains three hypothetical examples of how species traits
#  in mutualistic networks could coevolve under a scenario with no gene flow and under a scenario 
#  with gene flow.
#
# Returns:
...
fig1 = ggdraw() +
  ...
  draw_plot_label(c("A", "B", "C"), c(0, 0, 0), c(0.98, 0.65, 0.32), size = 26)

# saving
save_plot("output/figs/fig1.pdf", fig1, ncol = 1, nrow = 3, base_aspect_ratio = 1.8)
